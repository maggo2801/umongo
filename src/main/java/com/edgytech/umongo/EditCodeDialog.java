...
public class EditCodeDialog extends EditFieldDialog {
  ...
  public Object getValue() {
    final String code = getStringFieldValue(Item.value);
    final String scope = getStringFieldValue(Item.scope);
    if (!scope.isEmpty()) {
  ...
  public void setValue(final Object value) {
    ...
    if (code instanceof CodeWScope) {
      final BasicDBObject scope = (BasicDBObject) ((CodeWScope) code).getScope();
