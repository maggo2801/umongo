...
public class Resource {
  ...
  enum File {
    ...
    umongo, docView, textView, cmdView, queryResultView, dbJob, mongoNode, dbNode, collectionNode, indexNode, serverNode, routerNode, replSetNode, docBuilderDialog, docBuilderField, docFieldText
  }
